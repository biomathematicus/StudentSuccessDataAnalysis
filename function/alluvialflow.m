...
%
    ...
    % Color selection
    patch_colors =  colormap(lines(length(left_labels)));
                    %[ .5 .5 .5; 
                    %  1  0  0;
                    %  0  1  0;
                    %  0  0  1;
    ...
    text(zeros(1, size(data, 1)) - 0.01, ...
         ...
         left_labels, 'FontSize', nFontSize, 'HorizontalAlignment', 'right', 'VerticalAlignment', 'middle', 'Rotation', 0);
     
    % Place right labels
    text(ones(1, size(data, 2)) + 0.01, ...
         right_category_points + right_category_sizes./2, ...
         right_labels, 'FontSize', nFontSize, 'HorizontalAlignment', 'left', 'VerticalAlignment', 'middle', 'Rotation', 0);
